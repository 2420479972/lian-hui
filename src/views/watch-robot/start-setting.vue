    ...
    <div class="max-h-[90vh] w-[90vw] p-[20px] rounded-[20px] border-[#0E2C2C] border-[3px] flex flex-col">
      ...
      <div class="flex-1 overflow-y-auto">
        <div class="w-full">
          ...
          <div class="w-full my-[18px]">
            <div class="text-[18px] opacity-[0.4]">设置反买反卖交易延迟时间（S）</div>
          </div>
          <div class="flex items-center space-x-[14px]">
          ...
          <div class="w-full my-[18px]">
            <div class="text-[18px] opacity-[0.4]">设置自动买卖时间（min）</div>
          </div>
          <div class="flex items-center space-x-[14px]">
          ...
          <div class="w-full flex items-center justify-between mt-[32px]">
            <div class="text-[18px] opacity-[0.4]">设置主账户USDT（%）</div>
            <var-counter v-model="value"/>
          </div>
          <div class="w-full flex items-center justify-between mt-[32px]">
            <div class="text-[18px] opacity-[0.4]">设置主账户ERC20币（%）</div>
            <var-counter v-model="value"/>
          </div>
